  ...
  },
  {
    ...
    subs: [
      ...
      { id: 'entrance-animations', title: 'Entrance animations', body: `
        <p>Per-element IN animations play when a frame begins: <b>Fade In</b>, <b>Slide</b>, <b>Swipe</b>, <b>Zoom</b>, <b>Split</b>, <b>Blur</b>, plus three text-only presets — <b>Typing</b>, <b>Word Pop</b> and <b>Reveal</b>. Each has a duration and delay, and preset-specific settings (direction, blur radius, an added fade, and so on). Stagger the delays to build a sequence rather than animating everything at once.</p>
        ...
        <ul>
          ...
          <li><b>Word Pop</b> — each word scales up into place on an overshoot curve, arriving as distinct beats. Strong on short headlines and CTAs.</li>
...
const CHANGELOG_DATA = [
  {
    ...
    items: [
      ...
      'New Text Entrance — Word Pop: each word scales up into place on an overshoot curve, so the line arrives as a series of distinct beats rather than a smooth reveal. Reads quickly and holds attention on short headlines and calls to action.',
