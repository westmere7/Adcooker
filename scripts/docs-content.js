...
const CHANGELOG_DATA = [
  {
    ...
    items: [
      ...
      'GIF Compression Control: a Compression setting sits alongside Colours, with None / Light / Medium / Strong. GIF has no choice of codec — it is always LZW — so what actually moves the file size is how much colour detail is discarded before the palette is built, merging near-identical pixels into the flat runs LZW packs well. On a flat-vector banner the steps measured 0% / 5% / 13% / 17% smaller; photographic artwork saves considerably more. The size estimate tracks the setting and now lands within a couple of percent of the real file.',
