...
const CHANGELOG_DATA = [
  {
    ...
    items: [
      ...
      'The Advanced Submenu Is Gone: it held "Define default placement", which the new Save-placement submenu replaces while also naming the scope it saves to, and then a pair of per-role Forget entries. All of it has been removed — re-saving a placement overwrites it, which is how you correct one, and Settings still has the single switch that clears every remembered placement on your account. Fewer near-identical commands sharing one menu.',
