...
const CHANGELOG_DATA = [
  {
    ...
    items: [
      ...
      'Each New Transition Carries Its Own Easing: rather than putting everything on the one generic curve, Parallax and Lift arrive on a decelerating curve so the motion carries weight and then settles, Flip eases through the turn so the swap lands at the midpoint, and Punch accelerates hard out of the old frame before settling into the new one. The existing presets are untouched.',
